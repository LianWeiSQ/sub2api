export default {
  ...
  imageGeneration: {
    ...
    templates: {
      ...
      panelTitle: '创作场景',
      settingsTitle: '创作参数',
      description: '点一个风格模板，系统会把平台场景、画面结构和中文可读性要求自动写进提示词。',
      apply: '写入提示词',
      clear: '清除模板',
      quickActions: '快速增强',
      promptDraft: '提示词草稿',
      characters: '{count} 字',
      emptyTitle: '先选一个场景',
      emptyDescription: '左侧选择小红书、公众号、商业海报等场景后，这里会出现可填写的参数和可预览的提示词草稿。'
    },
    canvasTitle: '创作画布',
    freeCreate: '自由创作',
    refreshKey: '刷新可用密钥',
    loadingKey: '加载密钥中',
    noActiveKey: '无可用密钥',
    noKey: '当前账户没有可用的 OpenAI 生图 API 密钥，请先创建或启用一把 OpenAI 分组密钥。',
    createKey: '去创建密钥',
    uploadImage: '上传图片',
    emptyTitle: '想生成什么画面？',
    emptyDescription: '描述主体、风格和背景，生成完成后图片会显示在这里。',
    startFromPrompt: '从提示词开始',
    uploadToEdit: '上传图片编辑',
    promptPlaceholder: '描述你想生成的图片',
    editPromptPlaceholder: '描述你想怎么修改这张图片',
    generate: '生成',
    edit: '编辑',
    generating: '正在生成图片',
    editing: '正在编辑图片',
    ...
    continueEdit: '继续编辑',
    editSource: '编辑参考图',
    editSourceHint: '输入修改要求即可继续编辑，也可以涂抹局部区域。',
    latestResult: '上一张结果',
    uploadedImage: '上传图片',
    generatedImage: '生成图片',
    editedImage: '编辑图片',
    newImage: '新建图片',
    paintMask: '局部涂抹',
    closeMaskEditor: '收起涂抹',
    clearMask: '清除涂抹',
    maskReady: '已选择局部编辑区域',
    maskHint: '在图上涂抹要修改的区域；发送时只会重点修改涂抹位置。',
    brushSize: '画笔',
    keyLoadFailed: '加载 API 密钥失败',
    generateFailed: '生成图片失败',
    editFailed: '编辑图片失败',
    uploadFailed: '请选择图片文件',
    sourceLoadFailed: '这张图片无法继续编辑，请重新上传或重新生成。',
    timeoutMessage: '生图请求等待超过 10 分钟，上游可能排队或卡住了，请稍后再试。',
    networkErrorMessage: '生图连接被中断，可能是上游生图服务或代理断开了。请稍后重试；如果持续失败，请联系管理员查看后台日志。',
  ...
  admin: {
    ...
    usage: {
      ...
      gatewayCache: '网关缓存',
      gatewayCacheHitRate: '网关缓存命中率',
      gatewayCacheTarget: '目标 {target}',
      gatewaySavedTokens: '节省 Token',
      gatewaySavedTokenBreakdown: '输入 {input} / 输出 {output}',
      gatewaySavedCost: '节省成本',
      gatewayCacheEvents: '缓存事件',
      gatewayCacheHitShort: '命中',
      gatewayCacheMissShort: '未命中',
      gatewayCacheBypassShort: '绕过',
      gatewayCacheStoreShort: '写入',
      gatewayCacheBypassReason: '绕过原因',
      upstreamCallReduction: '减少上游调用 {count} 次',
      upstreamCallsAvoided: '减少上游调用',
      gatewayCacheTrend: '网关缓存趋势',
      gatewayCacheTrendHint: 'Response Cache',
      noGatewayCacheData: '暂无网关缓存数据',
      savedTokens: '节省',
      cacheStatus: '缓存状态',
      litellmBenchmarkTitle: 'Baseline vs LiteLLM 对照',
      litellmBenchmarkDescription: '10 个样本任务的 token、成本和延迟对照结果。',
      sampleSize: '样本数',
      noBenchmarkData: '暂无 LiteLLM 对照数据',
      benchmarkSavedTokens: '对照节省 Token',
      benchmarkHitRate: '对照命中率',
      benchmarkSavedCost: '对照节省成本',
      benchmarkLatencyDelta: '平均延迟差',
      sample: '样本',
      scenario: '场景',
      baselineTokens: '基线 Token',
      litellmTokens: 'LiteLLM Token',
      latencyDelta: '延迟差',
      gatewayCacheStatus: {
        hit: '命中',
        miss: '未命中',
