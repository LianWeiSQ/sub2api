export default {
  ...
  imageGeneration: {
    ...
    templates: {
      title: 'Choose a creation scene',
      panelTitle: 'Scenes',
      settingsTitle: 'Creative brief',
      description: 'Pick a style template and the workspace will write platform context, layout, and text-readability constraints into the prompt.',
      apply: 'Write prompt',
      clear: 'Clear template',
      quickActions: 'Quick refinements',
      promptDraft: 'Prompt draft',
      characters: '{count} chars',
      emptyTitle: 'Choose a scene first',
      emptyDescription: 'Choose Xiaohongshu, WeChat, commercial poster, or another scene on the left to reveal editable fields and a live prompt draft.'
    },
    canvasTitle: 'Canvas',
    ...
    noKey: 'This account has no available OpenAI image API key. Create or enable an OpenAI-group key first.',
    ...
    uploadToEdit: 'Upload to edit',
    promptPlaceholder: 'Describe the image you want',
    editPromptPlaceholder: 'Describe how you want to change this image',
    generate: 'Generate',
    edit: 'Edit',
    ...
    editSourceHint: 'Type an edit request, or paint a local area before sending.',
    latestResult: 'Latest result',
    uploadedImage: 'Uploaded image',
    generatedImage: 'Generated image',
    editedImage: 'Edited image',
    newImage: 'New image',
    paintMask: 'Paint area',
    closeMaskEditor: 'Close mask',
    clearMask: 'Clear mask',
    maskReady: 'Local edit area selected',
    maskHint: 'Paint the area you want changed. The edit request will focus on that region.',
    brushSize: 'Brush',
    keyLoadFailed: 'Failed to load API key',
    generateFailed: 'Failed to generate image',
    editFailed: 'Failed to edit image',
    uploadFailed: 'Please choose an image file',
    sourceLoadFailed: 'This image cannot be used for editing. Upload or generate another image.',
    ...
    networkErrorMessage: 'The image request connection was interrupted. The upstream image service or proxy may have disconnected. Please retry shortly, or ask an admin to check backend logs if it keeps failing.',
  ...
  admin: {
    ...
    usage: {
      ...
      gatewayCacheHitRate: 'Gateway cache hit rate',
      gatewayCacheTarget: 'Target {target}',
      gatewaySavedTokens: 'Saved tokens',
      gatewaySavedTokenBreakdown: 'Input {input} / output {output}',
      gatewaySavedCost: 'Saved cost',
      gatewayCacheEvents: 'Cache events',
      gatewayCacheHitShort: 'Hit',
      gatewayCacheMissShort: 'Miss',
      gatewayCacheBypassShort: 'Bypass',
      gatewayCacheStoreShort: 'Store',
      gatewayCacheBypassReason: 'Bypass reason',
      upstreamCallReduction: 'Avoided {count} upstream calls',
      upstreamCallsAvoided: 'Upstream calls avoided',
      gatewayCacheTrend: 'Gateway Cache Trend',
      gatewayCacheTrendHint: 'Response Cache',
      noGatewayCacheData: 'No gateway cache data yet',
      savedTokens: 'Saved',
      cacheStatus: 'Cache status',
      litellmBenchmarkTitle: 'Baseline vs LiteLLM',
      litellmBenchmarkDescription: 'Token, cost, and latency comparison for the 10 sample tasks.',
      sampleSize: 'Samples',
      noBenchmarkData: 'No LiteLLM benchmark data yet',
      benchmarkSavedTokens: 'Benchmark saved tokens',
      benchmarkHitRate: 'Benchmark hit rate',
      benchmarkSavedCost: 'Benchmark saved cost',
      benchmarkLatencyDelta: 'Avg latency delta',
      sample: 'Sample',
      scenario: 'Scenario',
      baselineTokens: 'Baseline tokens',
      litellmTokens: 'LiteLLM tokens',
